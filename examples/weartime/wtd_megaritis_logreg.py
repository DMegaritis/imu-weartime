r"""
.. _wtd_megaritis_logreg:

WTD Megaritis LogReg
====================

This example shows how to use the WtdMegaritis_LogReg algorithm for wear-time
detection using a pre-trained Logistic Regression model with time-domain and
...
# Apply algorithm
wtd_output = WtdMegaritisLogReg().detect(imu_data, sampling_rate_hz=sampling_rate_hz)
